...
from earned_understanding_battery.core.types import BatteryResult, InstrumentResult, SystemClass
from earned_understanding_battery.core.provenance import ProvenanceLog
from earned_understanding_battery.instruments.developmental_trajectory import run_developmental_trajectory, compute_trajectory_compression
from earned_understanding_battery.instruments.integration import run_integration, compute_integration_earned_ratio
...
def run_battery(
    ...
    if early_repr is not None and late_repr is not None:
        from earned_understanding_battery.analysis.cka import linear_cka, snapshot_hash
        import numpy as np
